...
public class Category {
     ...
     * @param imageUrl
     */
    public Category(int id, String name, String description, String imageUrl,Object sub_categories) {
        this.id = id;
        this.name = name;
    ...
    public Category(JSONObject JSONCategory) {
        try {
            ...
            sub_categories = JSONCategory.optJSONArray("sub_categories");
