...
public class Configurations {
    ...
    //Server URL
    public static String SERVER_URL = "http://www.tagly.in/wwwork/recipe/";
//    public static String SERVER_URL = "http://www.neurondigital.com/demos/recipeappv3/";
//
...
//
    ...
    //CATEGORIES------------------------------------------------------------------------------------
    public final static int CATEGORY_TEXT_ONLY = 0, CATEGORY_TEXT_AND_IMAGE = 1,CATEGORY_GRID_TEXT_AND_IMAGE = 3;
    public final static int CATEGORY_MENU_TYPE = CATEGORY_GRID_TEXT_AND_IMAGE;
